                            ...
                            {Array.from({ length: grid.cols }).map((_, colIndex) => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        // Inner fill
                                        "after:absolute after:inset-[var(--margin)] after:bg-background",
                                        ...
                                        "hover:after:bg-surface hover:after:duration-0",
                                        "hover:before:shadow-[0_0_20px_var(--glow-color)] transition-none"
                                    )}
