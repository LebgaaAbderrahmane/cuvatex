...
export default function StudyCase() {
  ...
  const tp = useTranslations('Projects.items.elearning');
        ...
        <div className="container">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-image">
              ...
              >
                <img src="/images/E-learning Experience.jpg" alt="E-learning App Mockup" />
              </motion.div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="content-grid">
              <div className="main-content">
                ...
                <p>
                  Developed a comprehensive E-learning platform that provides high-quality educational content and interactive learning experiences.
                </p>
                <p>
                  The engineering focused on high-performance video streaming and a seamless UI design that stays out of the user's way.
                </p>

                <h3 className="mt-48 sub-title">{t('sections.problem')}</h3>
                <p>
                  Engagement and retention were low due to fragmented delivery of educational content and lack of offline accessibility.
                </p>
              </div>
          ...
          <div className="container">
            <div className="content-narrow centered">
              ...
              <p className="lead impact-text-refined">
                Successfully empowered users to access high-quality educational content anywhere, anytime, significantly increasing learner engagement and knowledge retention.
              </p>
            </div>
          </div>
        </section>
