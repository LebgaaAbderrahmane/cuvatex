...
export default function StudyCase() {
  ...
  return (
    <main className="study-case-page">
      <FloatingIcons icons={[Cpu, BarChart3, Zap, Globe, Lock]} count={10} opacity={0.03} />
      {/* Hero Section */}
        ...
        <div className="container">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-image">
              ...
              >
                <img src="/images/AI SaaS Dashboard.jpg" alt="AI Dashboard Mockup" />
              </motion.div>
            </div>
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        .lead { font-size: 20px; color: var(--accent-2); line-height: 1.6; margin-bottom: 40px; }
        .impact-text-refined { font-size: 20px; color: var(--accent-2); line-height: 1.6; margin-bottom: 40px; }
