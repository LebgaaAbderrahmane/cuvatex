...
export default function StudyCase() {
  ...
  const tp = useTranslations('PortfolioDetail.projects.delivery');
          ...
          <div className="container">
            <div className="content-grid">
              <div className="main-content">
                ...
                <p>
                  Optimized a last-mile delivery ecosystem using real-time GPS tracking and intelligent routing algorithms.
                </p>
                <p>
                ...
                <p>
                  Inefficient routing and lack of real-time visibility lead to delayed deliveries and high operational costs in urban logistics.
                </p>
              </div>
          ...
          <div className="container">
            <div className="content-narrow centered">
              ...
              <p className="lead impact-text-refined">
                Enhanced urban logistics efficiency, reducing delivery times and operational overhead through technical innovation.
              </p>
            </div>
          </div>
        </section>
