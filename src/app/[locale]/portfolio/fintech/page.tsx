...
export default function StudyCase() {
  ...
  const tp = useTranslations('PortfolioDetail.projects.fintech');

  return (
    <main className="study-case-page">
      <FloatingIcons icons={[Database, Globe, Lock, BarChart3, Zap]} count={10} opacity={0.03} />
      {/* Hero Section */}
        ...
        <div className="container">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-image">
              ...
              >
                <img src="/images/fintech.jpg" alt="Fintech App Mockup" />
              </motion.div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="content-grid">
              <div className="main-content">
                ...
                <p>
                  Built a high-frequency trading platform focused on latency reduction and real-time data visualization.
                </p>
                <p>
                ...
                <p>
                  Modern financial markets move in milliseconds. Traditional dashboards often suffer from data lag and complex UIs that hinder rapid decision-making.
                </p>
              </div>
      ...
      <ScrollReveal>
        <section className="section bg-surface">
          <div className="container">
            <div className="content-narrow">
              <h2 className="section-title centered">{t('sections.deliverables')}</h2>
          ...
          <div className="container">
            <div className="content-narrow centered">
              ...
              <p className="lead impact-text-refined">
                Redefined technical performance in fintech, achieving industry-leading data throughput and user engagement.
              </p>
            </div>
          </div>
        </section>
