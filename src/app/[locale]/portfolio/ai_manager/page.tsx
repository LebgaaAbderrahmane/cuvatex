...
export default function StudyCase() {
  ...
  const tp = useTranslations('PortfolioDetail.projects.ai_manager');
          ...
          <div className="container">
            <div className="content-grid">
              <div className="main-content">
                ...
                <p>
                  Architected an AI-powered management tool that streamlines workflows and enhances decision-making through predictive analytics.
                </p>
                <p>
                  The engineering focused on seamless AI integration and a "clinical" UI design that stays out of the user's way.
                </p>

                <h3 className="mt-48 sub-title">{t('sections.problem')}</h3>
                <p>
                  Managing complex projects often leads to information overload and delayed decision-making due to lack of real-time insights.
                </p>
              </div>
          ...
          <div className="container">
            <div className="content-narrow centered">
              ...
              <p className="lead impact-text-refined">
                Successfully empowered managers with data-driven insights, leading to improved operational efficiency and faster project delivery.
              </p>
            </div>
          </div>
        </section>
