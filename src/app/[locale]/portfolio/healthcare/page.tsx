...
export default function StudyCase() {
  ...
  const tp = useTranslations('Projects.items.healthcare');
        ...
        <div className="container">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-image">
              ...
              >
                <img src="/images/heathcare.jpg" alt="Healthcare App Mockup" />
              </motion.div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="content-grid">
              <div className="main-content">
                ...
                <p>
                  Delivered a comprehensive healthcare platform connecting patients with providers for seamless appointment management and health record access.
                </p>
                <p>
                ...
                <p>
                  Fragmented patient data and complex scheduling systems often lead to poor patient experiences and administrative overhead in healthcare facilities.
                </p>
              </div>
          ...
          <div className="container">
            <div className="content-narrow centered">
              ...
              <p className="lead impact-text-refined">
                Transformed patient engagement through digital innovation, delivering a scalable and secure healthcare ecosystem.
              </p>
            </div>
          </div>
        </section>
